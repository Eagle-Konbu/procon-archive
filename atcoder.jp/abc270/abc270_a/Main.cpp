...
int main()
{
    ...
    vector<bool> tak = {false, false, false}, aok = {false, false, false};
    if (a == 1)
        tak[0] = true;
    else if (a == 2)
        tak[1] = true;
    ...
    if (b == 1)
        ...
        aok[0] = aok[1] = aok[2] = true;

    vector<bool> snuke = {true, true, true};

    rep(i, 3) if (tak[i] == false && aok[i] == false) snuke[i] = false;
