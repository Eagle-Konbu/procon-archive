...
int main()
{
    ...
    rep(i, n)
    {
        ll x = get<0>(circles[i]), y = get<1>(circles[i]), r = get<2>(circles[i]);
    ...
    rep(i, n) rep(j, n)
    {
        if (i == j)
            continue;
        ll x1 = get<0>(circles[i]);
        ll y1 = get<1>(circles[i]);
        ll r1 = get<2>(circles[i]);
        ll x2 = get<0>(circles[j]);
        ll y2 = get<1>(circles[j]);
        ll r2 = get<2>(circles[j]);
